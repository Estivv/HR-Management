...
(1, ' Ethiopian Christmas Day', '7 Jan 2023', '7 Jan 2023', '1', 'Jan 2023'),
(3, 'epiphany(Timket)', '20 Jan 2023', '20 Jan 2023', '1', 'Jan-2023'),
(5, 'Adwa-victory-day', '2 Feb 2023', '2 Feb 2023', '1', 'Feb-2023');
-- --------------------------------------------------------
...
ALTER TABLE `employee` ADD `div_id` VARCHAR(250) NULL DEFAULT NULL AFTER `em_nid`, ADD INDEX `id` (`div_id`(250));
ALTER TABLE `employee` CHANGE `em_blood_group` `em_blood_group` ENUM('Permanent','Part-Time','Contractual','Volunteer','Remote','Intern') CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL;
ALTER TABLE `employee` CHANGE `em_nid` `em_nid` VARCHAR(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL;
ALTER TABLE `education` ADD `study` VARCHAR(256) CHARACTER SET latin2 COLLATE latin2_general_nopad_ci NULL DEFAULT NULL AFTER `edu_type`;
ALTER TABLE `employee` ADD `em_bloood_group` ENUM('A+','A-','B+','B-','AB+','AB-','O+','O-') CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL AFTER `em_blood_group`;
ALTER TABLE `employee_file` ADD `action` VARCHAR(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `em_id`;
ALTER TABLE `employee` ADD `em_workplace` ENUM('Head Office','Summit Branch','Hayat Branch','Bole Branch','Adwa Branch') CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL AFTER `em_blood_group`;
ALTER TABLE `loan_installment` CHANGE `loan_id` `loan_id` VARCHAR(256) NOT NULL;
ALTER TABLE `loan` ADD `dept` VARCHAR(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL AFTER `installment`;
ALTER TABLE `loan` CHANGE `status` `status` VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'Pause';