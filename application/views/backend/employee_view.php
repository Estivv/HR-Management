...
<?php $this->load->view('backend/sidebar'); ?>
            ...
            <div class="row page-titles">
                ...
                <?php $divvalue = $this->employee_model->getdivision(); ?>
                            ...
                            <div class="card-body">
                                <center class="m-t-30">
                                   <?php if(!empty($basic->em_image)){ ?>
                                    <img src="<?php echo base_url(); ?>assets/images/users/<?php echo $basic->em_image; ?>" class="img-circle" width="250" />
                                    <?php } else { ?>
                                    <img src="<?php echo base_url(); ?>assets/images/users/user.png" class="img-circle" width="250" alt="<?php echo $basic->first_name ?>" title="<?php echo $basic->first_name ?>"/>                                   
                                    <?php } ?>
                                ...
                                <a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->google_Plus)) echo $socialmedia->google_Plus ?>" target="_blank"><i class="fa fa-google"></i></a>
				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group col-md-4 m-t-10">
                                                        ...
                                                        <select name="place" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $basic->em_blood_group; ?>" class="form-control custom-select">
                                                            <option value="<?php echo $basic->em_workplace; ?>"><?php echo $basic->em_workplace; ?></option>
                                                            <option value="Head Office">Head Office</option>
                                                            <option value="Summit Branch">Summit Branch</option>
                                                            <option value="Hayat Branch">Hayat Branch</option>
                                                            <option value="Bole Branch">Bole Branch</option>   
                                                            <option value="Adwa Branch">Adwa Branch</option>
                                                               
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-4 m-t-10">
                                                        <label>Blood Type </label>
                                                        <select name="bloood" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $basic->em_bloood_group; ?>" class="form-control custom-select">
                                                            <option value="<?php echo $basic->em_bloood_group; ?>"><?php echo $basic->em_bloood_group; ?></option>
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } else { ?> 				                                    
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <select name="dept" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> hidden <?php } ?> class="form-control custom-select">
                                            ...
                                            <?php endforeach; ?>
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } else { ?> 				                                    
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <select name="div" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control custom-select">
				                                            <option value="<?php echo $basic->id; ?>"><?php echo $basic->div_name; ?></option>
                                            <?Php foreach($divvalue as $value): ?>
                                            <option value="<?php echo $value->id ?>"><?php echo $value->div_name ?></option>
                                            <?php endforeach; ?>
				                                        </select>
				                                    </div>
				                                    <?php } ?>
                                    ...
                                    <div class="card">
	                                    ...
	                                    <div class="card-body">
                                         ...
                                         <label>Degree Title </label>
                                                        <select name="name" class="form-control form-control-line" placeholder=" Degree Title" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="1" required><?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $basic->em_blood_group; ?>" class="form-control custom-select">
                                                            
                                                            <option value="Bsc Degree">Bsc Degree</option>
                                                            <option value=" Doctoral Degree"> Doctoral Degree</option>
                                                            <option value="Masters Degree">Masters Degree</option>    
                                                            <option value="Bachelor Degree">Bachelor Degree</option>
                                                            <option value="Graduate Certificate or Diploma">Graduate Certificate or Diploma</option>
			                                        ...
			                                        <input type="text" name="study" class="form-control form-control-line" placeholder=" field of study" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" required> 
			                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                       ...
                                       <?php } else { ?>
                                        ...
                                        <a onclick="confirm('Are you sure, you want to delete this?')" href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light deletfile" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
...
<script type="text/javascript">
                                        $(document).ready(function () {
                                            $(".fileinfo").click(function (e) {
                                                ...
                                                // Get the record's ID via attribute  
                                                var iid = $(this).attr('data-id');
                                                $('#fileinfomodal').trigger("reset");
                                                $('#FileModal').modal('show');
                                                $.ajax({
                                                    url: 'fileinfobyib?id=' + iid,
                                                    method: 'GET',
                                                    data: '',
                                                    dataType: 'json',
                                                }).done(function (response) {
                                                    console.log(response);
                                                    // Populate the form fields with the data returned from server
													$('#fileinfomodal').find('[name="id"]').val(response.filevalue.id).end();
                                                    $('#fileinfomodal').find('[name="title"]').val(response.filevalue.file_title).end();
