...
<form class="row" method="post" action="Save" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <select name="div" class="form-control custom-select" required>
...
<select name="gender" class="form-control custom-select" required>
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <select name="place" class="form-control custom-select">     
                                      ...
                                      <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <select name="bloood" class="form-control custom-select">     
