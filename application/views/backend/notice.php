                    ...
                    <div class="col-12">
                                        ...
                                        <tbody>
                                           <?php foreach($notice as $value): ?>
                                            <tr>
                                                ...
                                                <a onclick="confirm('Are you sure, you want to delete this?')" href="#" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light noticedelet"  data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                        ...
                        <script type="text/javascript">
                                        $(document).ready(function () {
                                            $(".noticedelet").click(function (e) {
                                                e.preventDefault(e);
                                                // Get the record's ID via attribute  
                                                var iid = $(this).attr('data-id');
                                                $.ajax({
                                                    url: 'NoticevalueDelet?id=' + iid,
                                                    method: 'GET',
                                                    data: 'data',
